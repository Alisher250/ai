            ...
            if len(det):
                ...
                for *xyxy, conf, cls in reversed(det):
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        if "Prohibitory" in str(label):
                            os.system('espeak "{}"'.format("Prohibitory"))
                        if "Mandatory" in str(label):
                            os.system('espeak "{}"'.format("Mandatory"))
                        if "Danger" in str(label):
                            os.system('espeak "{}"'.format("Danger"))
                        if "Other" in str(label):
                            os.system('espeak "{}"'.format("Other"))
